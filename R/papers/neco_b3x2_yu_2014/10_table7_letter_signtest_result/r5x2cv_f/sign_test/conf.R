...
temp_dir <- "/apps/users/wrb/trunk/papers/neco_yu/table7_letter_signtest_result/r5x2cv_f"
temp_dir_var <- "/apps/users/wrb/trunk/papers/neco_yu/table7_letter_signtest_result/r5x2cv_t"
...
conf_TASK_SIGN_TEST <- list(algor1_path = file.path(temp_dir_var, "variance_simulation_cla_tree", "data", 
                                                    fsep = .Platform$file.sep) ,
                            algor2_path = file.path(temp_dir_var, "variance_simulation_fnn", "data", 
                                                    fsep = .Platform$file.sep) , 
                            diff_mu_file_name = "diff_mu",
                            test_type = "Alpaydin_f_test",
                            alpha = 0.05, 
                            freedegree = 10,
                            freedegree2 = 5,
                            true_mu = 0.0, 
